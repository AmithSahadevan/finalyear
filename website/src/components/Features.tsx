                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            className="glass-panel p-8 rounded-2xl hover:bg-white/10 transition-all duration-300 bg-white/5 border border-white/10 hover:border-emerald-500/30 group"
                        >
                            <div className="mb-6 p-3 bg-emerald-900/20 w-fit rounded-xl border border-emerald-500/20 group-hover:scale-110 transition-transform duration-300">
                                {feature.icon}
                            </div>
